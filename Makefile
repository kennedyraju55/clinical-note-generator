...
lint: ## Run linting
	python -m py_compile src/clinical_note_generator/core.py
	python -m py_compile src/clinical_note_generator/cli.py

run-cli: ## Run CLI tool
	python -m clinical_note_generator.cli generate --encounter "Patient with headache"
